            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20,),
                  sharedTextFormField(controller: cubit.firstNamePatientController, validator: (value){
                    ...
                    return null;
                  }, isPassword: false,label: 'First Name'),
                  SizedBox(height: 10,),
                  sharedTextFormField(controller: cubit.lastNamePatientController, validator: (value){
                    if (value == null || value.isEmpty) {
                      return 'Please enter a valid name';
                    }
                    if (!nameRegex.hasMatch(value)) {
                  ...
                  }, isPassword: false,label: 'last Name'),
                  SizedBox(height: 10,),
                  sharedTextFormField(
                  ...
                  Center(child: sharedMaterialButtonAccount(onPressed: (){
                    if(formKey.currentState!.validate()&&cubit.selectedIndexAddPatient!=-1&&cubit.selectedGenderAddPatient!=null&&cubit.firstDateToDonateController.text.isNotEmpty&&cubit.lastDateToDonateController.text.isNotEmpty)
                    {
                      String bloodType='';
